            ...
            <div className='left'>
              <div className='box box_shodow'>
                <div className='details'>
                  ...
                  <p>Je suis disponible pour des projets en freelance. N'hésitez pas à me contacter pour toute collaboration, consultation ou expertise web en me contactant par email ou téléphone. Discutons ensemble de vos besoins et de la manière dont je peux vous aider à réaliser vos objectifs.</p> 
                  <div className="phone">
                  ...
                  <div className="email"> 
                    <a href="mailto:abidfatem@gmail.com" className="email-content">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="email-icon">
                  ...
                  <div className='linkedin'>
                    <a href="https://www.linkedin.com/in/fatima-abid-91b200196/">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="linkedin-icon">
                  ...
                  <div className='github'>
                    <a href="https://github.com/fatemzh">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="github-icon">
